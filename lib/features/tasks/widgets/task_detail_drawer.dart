...
class TaskDetailDrawer extends StatelessWidget {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _infoRow(
                    ...
                    'Người giao',
                    task.assignedBy.isEmpty ? 'Chưa xác định' : task.assignedBy,
                  ),
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Text(
                          'Việc con (${task.subtasksDone}/${task.subtasksTotal})',
                          style: AppTextStyles.titleSmall.copyWith(
                            color: colors.textSecondary,
                          ),
                        ),
                  ...
                  ...List.generate(
                    ...
                    (i) => _subtaskRow(
                      context,
                      i < task.subtasksDone,
                      'Subtask ${i + 1}: ${_subtaskNames[i % _subtaskNames.length]}',
                    ),
                  ),
                  const SizedBox(height: 20),
                  const Divider(),
                  ...
                  _commentBubble(
                    context,
                    'Nguyễn Văn An',
                    'Mọi người review giúp mình PR này nhé',
                    '09:30',
                  ),
                  _commentBubble(
                    context,
              ...
              children: [
                ...
                Container(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () =>
                        showHrmSuccessSnackbar(context, 'Đã gửi bình luận'),
                  ),
                ),
              ],
            ),
        ...
        children: [
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Icon(Icons.edit_outlined, size: 14, color: colors.info),
            ),
          ),
          InkWell(
  ...
  Widget _multiAssigneeRow(BuildContext context) {
    final colors = AppColors.of(context);
    final assignees = task.assignees.isNotEmpty
        ? task.assignees
        : [task.assignee];
    return Padding(
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const TextField(
              autofocus: true,
              decoration: InputDecoration(hintText: 'Tên việc con...'),
            ),
            const SizedBox(height: 12),
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  Navigator.pop(ctx);
                  showHrmSuccessSnackbar(context, 'Đã thêm việc con mới');
                },
  ...
  Widget _reminderChip(BuildContext ctx, String label, BuildContext parentCtx) {
    return Material(
      ...
      child: InkWell(
        onTap: () {
          Navigator.pop(ctx);
          showHrmSuccessSnackbar(parentCtx, 'Đã đặt nhắc: $label');
        },
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.pop(ctx);
              onClose();
              showHrmSuccessSnackbar(context, 'Đã xóa công việc');
            },
  ...
  Widget _commentBubble(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          UserAvatar(
            initials: author.split(' ').map((w) => w[0]).take(2).join(),
            size: 28,
          ),
          const SizedBox(width: 10),
          Expanded(
