      ...
      child: Column(
        ...
        children: [
          ...
          FittedBox(
            ...
            child: Text(value, style: AppTextStyles.kpiValue.copyWith(fontSize: isMobile ? 22 : 32)),
          ),
          const SizedBox(height: 2),
          Text(title, style: AppTextStyles.kpiLabel.copyWith(fontSize: isMobile ? 11 : 13), maxLines: 1, overflow: TextOverflow.ellipsis),
        ],
      ),
    );
  }
